...
SOURCES = \
	__init__.py \
	document_connector.py document_connector_dialog.py

PLUGINNAME = document_connector

PY_FILES = \
	__init__.py \
	document_connector.py document_connector_dialog.py

UI_FILES = document_connector_dialog_base.ui
...
QGISDIR=C:\Users\amatz\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
